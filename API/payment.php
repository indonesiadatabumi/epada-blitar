...
teller_log('PAYMENT', $_SERVER['REQUEST_METHOD'], $_SERVER['REMOTE_ADDR'], $_SERVER['HTTP_USER_AGENT'], json_encode($data), json_encode($array_rest), $response_code, date('Y-m-d H:i:s'));
